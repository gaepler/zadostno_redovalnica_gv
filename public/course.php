...
<div class="container">
    ...
    <div class="card mt-4" id="assignment_form">
        <div class="card-header"><h3>
            <?php echo $edit_assignment ? 'Uredi nalogo' : 'Dodaj novo nalogo'; ?>
        </h3>
    </div>
    <div class="card-body">
